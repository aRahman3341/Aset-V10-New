...
class AsetKeluarExportAll implements FromCollection, WithHeadings, WithStyles, WithTitle, ShouldAutoSize
{
    /**
    ...
    {
        // Ambil semua data aset keluar tanpa filter tanggal
        $asetKeluarList = AsetKeluar::orderBy('created_at', 'asc')->get();
    ...
    {
        return 'Rekap Semua Aset Keluar';
    }
