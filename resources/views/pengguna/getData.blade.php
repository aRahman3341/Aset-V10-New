...
<div class="main-card">
    ...
    <div class="table-toolbar">
        ...
        <div class="toolbar-right">
            @php $jabatanSess = strtolower($sess['jabatan'] ?? ''); @endphp
        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <span class="pwd-badge"><i class="bi bi-key-fill"></i> Aktif</span>
                    </td>
                    <td class="text-center">
...
.pagetitle-icon { width:44px; height:44px; background:linear-gradient(135deg,#012970,#4154f1); border-radius:12px; display:flex; align-items:center; justify-content:center; color:#fff; font-size:1.15rem; box-shadow:0 4px 12px rgba(1,41,112,0.22); }
...
.section-label { padding:9px 16px; background:#f6f9ff; border-top:2px solid rgba(1,41,112,0.07); border-bottom:1px solid rgba(1,41,112,0.07); font-size:0.78rem; font-weight:800; color:#012970; display:flex; align-items:center; gap:8px; letter-spacing:0.3px; text-transform:uppercase; }
.section-label-2 { border-top:3px solid rgba(1,41,112,0.10); }
...
/* ── Pagination (sama persis Aset Tetap) ── */
.table-footer {
