...
.footer-summary {
    ...
    border-left:1px solid rgba(1,41,112,0.08); gap:0; flex-shrink:0;
}
...
.fs-sep  { width:1px; height:38px; background:rgba(1,41,112,0.09); margin:0 2px; }
.fs-total { color:#012970; }
.fs-atk   { color:#4154f1; }
.fs-rt    { color:#10b981; }
.fs-lab   { color:#ff771d; }
