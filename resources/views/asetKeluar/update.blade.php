			...
			<div class="card-body">
				<form class="row g-3" method="POST" action="{{ route('asetkeluar.update', $asetKeluar->id) }}">
					...
					<div class="col-12">
                        ...
                        <input type="text" class="form-control" name="nomor" id="nomor" value="{{ $asetKeluar->nomor }}">
                        @error('nomor')
                    ...
                    <div class="col-12">
						...
						<input type="text" class="form-control" name="kepada" id="kepada" value="{{ $asetKeluar->kepada }}">
						@error('kepada')
							<div class="text-danger">{{ $message }}</div>
						@enderror
					</div>
