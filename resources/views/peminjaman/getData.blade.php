...
<div class="main-card">
        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        {{-- Indikator password sudah pernah diubah atau masih default --}}
                    ...
                    <td class="text-center">
                        <div class="action-group">
                            @if($sess['jabatan'] === 'operator')
                                @if($sess['id'] == $item->id && $sess['type'] === 'user')
    ...
    {{-- ══════════════════════════════════════════════
         TABEL 2 — Karyawan (employees, tidak bisa login)
    ══════════════════════════════════════════════ --}}
...
.section-label {
    padding:9px 16px;
    background:#f6f9ff;
    border-top:2px solid rgba(1,41,112,0.07);
...
.section-badge {
    background:rgba(65,84,241,0.10); color:#4154f1;
...
.pwd-badge {
    ...
    border-radius:20px; background:rgba(16,185,129,0.10); color:#10b981;
}
...
.pag-ellipsis span {
    display:inline-flex; align-items:center; justify-content:center;
    width:34px; height:34px; color:#a0aab4;
}
