...
<style>
    ...
    .pm-label {
        ...
        color: #4a5a6e; margin-bottom: 6px;
    ...
    .pm-input:focus, .pm-select:focus {
        background: #fff;
        border-color: #2d5a8e;
        box-shadow: 0 0 0 3px rgba(45,90,142,0.10);
    }
    ...
    .pm-divider {
        ...
        color: #8a96a3; text-transform: uppercase; letter-spacing: 0.5px;
    }
    .pm-divider::before, .pm-divider::after {
        content: ''; flex: 1;
        height: 1px; background: rgba(30,58,95,0.08);
    }
    ...
    .select2-container--default.select2-container--focus .select2-selection--single {
        ...
        box-shadow: 0 0 0 3px rgba(45,90,142,0.10) !important;
